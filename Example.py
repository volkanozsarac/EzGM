...
cs = cs_master(Tstar = np.arange(0.4,2.4,0.2), gmpe = 'Boore_EtAl_2014', database = 'NGA_W2', pInfo = 1)
...
# 5.) write what you want, the object, selected and scaled time histories
# For this option you have to have records already inside recs_f\database.zip\database for this option, however,
